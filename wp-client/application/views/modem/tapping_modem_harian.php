...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <span>Tapping Modem Harian</span>
        </li>
    </ul>
</div>
<!-- end breadcrumb -->
...
<div>
	<div class="row">
		<div class="col-md-5 form-inline">Harian	:
		...
		<div class="col-md-4 col-md-offset-1 form-inline">
			<label>Total Harian <b>[Rp]</b>:</label>
...
<script>
    ...
    $("#generatetable").on('click',function() {
    	jQuery("#grid-table").jqGrid('setGridParam', {
            url: '<?php echo WS_JQGRID."modem.tapping_modem_controller/getdata_harian"; ?>',
            datatype: 'json',
